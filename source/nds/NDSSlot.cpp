...
namespace S2Editor {
	...
	/* Get and Set Name. */
	std::string NDSSlot::Name() const { return SavUtils::ReadString(this->Offs + 0x30, 0x7); };
	void NDSSlot::Name(const std::string &V) { SavUtils::WriteString(this->Offs + 0x30, 0x7, V); };
