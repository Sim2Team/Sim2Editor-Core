...
namespace S2Editor {
	...
	*/
	...
	/* Get and Set Name. */
	std::string GBASlot::Name() const { return SavUtils::ReadString(this->Offs + 0xD, 0x8); };
	void GBASlot::Name(const std::string &V) { SavUtils::WriteString(this->Offs + 0xD, 0x8, V); };
